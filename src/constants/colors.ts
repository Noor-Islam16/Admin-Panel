/**
 * Color System — WhatsApp-themed Admin Panel
 * Mirror of the React Native color scheme, adapted for web/Tailwind CSS variables
 */
...
const Colors = {
  ...
  // ─── Gradient stops (for CSS linear-gradient) ───────────────────────────
